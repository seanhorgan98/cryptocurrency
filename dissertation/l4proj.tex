...
%String Util class
%How project was separated into classes
...
%Process using Github, Milestones, Issues, Branching
\subsection{Version Control}
%Github and the decision for no continuous integration (no point updating master as it wouldn't work until near end)
...
an issue and then those issues were assigned to one of the milestones. This made it easy to prioritise each feature
and keep on track with what needed to be done.
