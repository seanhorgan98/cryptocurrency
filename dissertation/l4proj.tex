...
a result the transaction did not make it through the nodes checks and was not added to the blockchain.
...
transaction was caught and not flooded to any other nodes or added to the block a second time.
