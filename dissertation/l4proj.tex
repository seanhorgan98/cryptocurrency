...
of the security packages that are included in the language. These packages were utilised mainly in a class created
...
by a node to put into a block it attempts to verify the signature that was created by the sender. It feed the metadata
