...
\begin{abstract}
    ...
    decentralised alternative to regular physical currencies. The goal of this project is to implement a secure, peer-based 
...
%MoSCoW remember to mention the W for wont have
...
received and also contain the necessary information such as the amount of currency being sent in that transaction.
...
format shown in listing \ref{lst:transactionCreation}. The senderAddress and receiverAddress are the public keys
...
\begin{lstlisting}[language=java, float=h, caption={This code snippet shows how transactions are created using
    ...
    Transaction exampleTransaction = new Transaction(senderAddress, receiverAddress, value, inputs);
\end{lstlisting}
...
\begin{lstlisting}[language=java, float=h, caption=
    {
        ...
        attacks This code was created with help from \cite{miningcode}.
    }
    , label=lst:mining]
