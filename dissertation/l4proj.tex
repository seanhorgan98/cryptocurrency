...
This new currency ensured security to its users by implementing a distrobuted ledger of transactions. Bitcoin
...
users from altering the system. The blockchain has become more than just a measure for MAINTAINING security
...
Talk about monitary value compared to FIAT currencies. Maybe inflation and how it is not tied to a physical
object.

\section{Goals}
The goal of this project is to create a secure and ** cryptocurrency from scratch.
Explain features listed in abstract.
